...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _helpers_helpers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../helpers/helpers */ \"./src/helpers/helpers.js\");\n\n\nvar CardHelpers = function a() {\n  function iconSrc(sunRise, description) {\n    var src = './icons/cloudy.svg';\n\n    if (sunRise) {\n      if (description.includes('clear')) {\n        src = './icons/day.svg';\n      } else if (description.includes('drizzel')) {\n        src = './icons/rainy-day.svg';\n      } else if (description.includes('rain')) {\n        src = './icons/rainy-day.svg';\n      } else if (description.includes('thunderstorm')) {\n        src = './icons/thunder.svg';\n      } else if (description.includes('snow')) {\n        src = './icons/snow.svg';\n      } else if (description.includes('clouds')) {\n        src = './icons/cloudy-day.svg';\n      }\n    } else if (description.includes('clear')) {\n      src = './icons/night.svg';\n    } else if (description.includes('drizzel')) {\n      src = './icons/rainy-night.svg';\n    } else if (description.includes('rain')) {\n      src = './icons/rainy-night.svg';\n    } else if (description.includes('thunderstorm')) {\n      src = './icons/thunder.svg';\n    } else if (description.includes('snow')) {\n      src = './icons/snow.svg';\n    } else if (description.includes('clouds')) {\n      src = './icons/cloudy-night.svg';\n    }\n\n    return src;\n  }\n\n  function isSunrise(sunriseStamp, sunsetStamp) {\n    var currentHour = new Date().getHours();\n    return !(_helpers_helpers__WEBPACK_IMPORTED_MODULE_0__[\"default\"].convertUnixTime(sunriseStamp).hours <= currentHour && currentHour < _helpers_helpers__WEBPACK_IMPORTED_MODULE_0__[\"default\"].convertUnixTime(sunsetStamp));\n  }\n\n  function append(object) {\n    var country = document.querySelector('.country');\n    var city = document.querySelector('.city');\n    var temp = document.querySelector('.main h1');\n    var icon = document.querySelector('.main img');\n    var description = document.querySelector('.label');\n    var humidity = document.querySelector('.humidity');\n    var pressure = document.querySelector('.pressure');\n    var wind = document.querySelector('.wind');\n    country.textContent = object.country;\n    city.textContent = object.city;\n    temp.textContent = \"\".concat(object.temp, \"\\xB0\");\n    description.textContent = \"Description: \".concat(object.description);\n    humidity.textContent = \"\".concat(object.humidity, \"%\");\n    pressure.textContent = \"\".concat(object.pressure, \" hPa\");\n    wind.textContent = \"\".concat(object.windSpeed, \" m/s\");\n    var sunrise = isSunrise(object.sunrise, object.sunset);\n    icon.src = iconSrc(sunrise, object.description);\n  }\n\n  return {\n    iconSrc: iconSrc,\n    isSunrise: isSunrise,\n    append: append\n  };\n}();\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (CardHelpers);\n\n//# sourceURL=webpack:///./src/components/card/card.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\n/* eslint-disable */\nfunction fetchingData(_x, _x2) {\n  return _fetchingData.apply(this, arguments);\n}\n\nfunction _fetchingData() {\n  _fetchingData = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(city, unit) {\n    var response, data;\n    return regeneratorRuntime.wrap(function _callee$(_context) {\n      while (1) {\n        switch (_context.prev = _context.next) {\n          case 0:\n            _context.prev = 0;\n            _context.next = 3;\n            return fetch(\"https://api.openweathermap.org/data/2.5//weather?q=\".concat(city, \"&units=\").concat(unit, \"&appid=\").concat(\"cb4e9eeaf8ff238bc65f0cd98ce8071d\"), {\n              mode: 'cors'\n            });\n\n          case 3:\n            response = _context.sent;\n            _context.next = 6;\n            return response.json();\n\n          case 6:\n            data = _context.sent;\n            return _context.abrupt(\"return\", data);\n\n          case 10:\n            _context.prev = 10;\n            _context.t0 = _context[\"catch\"](0);\n            console.log(_context.t0);\n\n          case 13:\n          case \"end\":\n            return _context.stop();\n        }\n      }\n    }, _callee, null, [[0, 10]]);\n  }));\n  return _fetchingData.apply(this, arguments);\n}\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (fetchingData);\n\n//# sourceURL=webpack:///./src/helpers/fetch.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\nvar Helpers = function b() {\n  function convertUnixTime(unixTime) {\n    // Create a new javascript Date object base on the timestamp\n    // mutiplied by 100 so that the argument is in milliseconds\n    var date = new Date(unixTime * 1000); // Hours part of the timestamp\n\n    var hours = date.getHours(); // Minutes part from the timestamp\n\n    var minutes = \"0\".concat(date.getMinutes()); // Seconds part from the timestamp\n\n    var seconds = \"0\".concat(date.getSeconds()); // Will display time in 10:30:23 format\n\n    var formattedTime = \"\".concat(hours, \":\").concat(minutes.substr(-2), \":\").concat(seconds.substr(-2));\n    return {\n      hours: hours,\n      formattedTime: formattedTime\n    };\n  }\n\n  function hideLoader() {\n    document.querySelector('.loader').style.display = 'none';\n    document.querySelector('.card').style.display = 'block';\n  }\n\n  function showLoader() {\n    document.querySelector('.loader').style.display = 'block';\n    document.querySelector('.card').style.display = 'none';\n  }\n\n  return {\n    convertUnixTime: convertUnixTime,\n    hideLoader: hideLoader,\n    showLoader: showLoader\n  };\n}();\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (Helpers);\n\n//# sourceURL=webpack:///./src/helpers/helpers.js?");

/***/ }),

/***/ "./src/helpers/logic.js":
/*!******************************!*\
  !*** ./src/helpers/logic.js ***!
  \******************************/
/*! no exports provided */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./helpers */ \"./src/helpers/helpers.js\");\n/* harmony import */ var _fetch__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./fetch */ \"./src/helpers/fetch.js\");\n/* harmony import */ var _components_card_card__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/card/card */ \"./src/components/card/card.js\");\n\n\n\n\n(function c() {\n  var input = document.querySelector('#city');\n  var button = document.querySelector('button');\n  var celsius = document.querySelector('.celsius');\n  var fahrenheit = document.querySelector('.fahrenheit');\n  var city = '';\n\n  function fetchData(value, metric) {\n    _helpers__WEBPACK_IMPORTED_MODULE_0__[\"default\"].showLoader();\n    Object(_fetch__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(value, metric).then(function (data) {\n      input.value = '';\n      _helpers__WEBPACK_IMPORTED_MODULE_0__[\"default\"].hideLoader();\n      var processData = {\n        country: data.sys.country,\n        city: data.name,\n        temp: data.main.temp,\n        description: data.weather[0].description,\n        humidity: data.main.humidity,\n        pressure: data.main.pressure,\n        sunset: data.sys.sunset,\n        sunrise: data.sys.sunrise,\n        windSpeed: data.wind.speed\n      };\n      _components_card_card__WEBPACK_IMPORTED_MODULE_2__[\"default\"].append(processData);\n    });\n  }\n\n  button.addEventListener('click', function (e) {\n    if (input.value !== '') {\n      fetchData(input.value, 'metric');\n      city = input.value;\n      e.preventDefault();\n    }\n  }, false);\n  celsius.addEventListener('click', function (e) {\n    if (city !== '') {\n      fetchData(city, 'metric');\n      e.preventDefault();\n    }\n  }, false);\n  fahrenheit.addEventListener('click', function (e) {\n    if (city !== '') {\n      fetchData(city, 'imperial');\n      e.preventDefault();\n    }\n  }, false);\n})();\n\n//# sourceURL=webpack:///./src/helpers/logic.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.scss */ \"./src/style.scss\");\n/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_style_scss__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _helpers_logic__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./helpers/logic */ \"./src/helpers/logic.js\");\n/* eslint-disable */\n\n\n\n//# sourceURL=webpack:///./src/index.js?");
